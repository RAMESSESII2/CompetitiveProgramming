...
void run_case(){
    ...
    else if( k <= n/2 ) cout << k << endl;
    else{
        x = n/2;
        int quotient, rem;
        quotient = (k-1)/x;
        rem = (k-1)%x;
        cerr << " quotient: " << quotient << " rem: " << rem << endl;
        int clashPos = (x*quotient+1);
        cerr << clashPos << endl;
        int aAtClaspos = (clashPos+1)%(n);
        cerr << aAtClaspos<< endl;
        int bAtClashPos = ((aAtClaspos)+1)%(n+1);
        cerr << bAtClashPos<< endl;
        if( rem == 0 ){
            cout << bAtClashPos << endl;
        }
        else{
            cout << bAtClashPos+rem << endl;
        }
