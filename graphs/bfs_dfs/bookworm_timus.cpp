...
void run_case(){
    int thickness, coverThickness, start, end;
    cin >> thickness >> coverThickness >> start >> end;
    int totalThickness = thickness + 2*coverThickness;
    if( start < end ){
        cout << totalThickness * (end-start-1) + 2*coverThickness;
    }
    else if( start > end )
        cout << totalThickness * (start-end-1) + 2*(coverThickness + thickness);

    else cout << totalThickness;
    cout<< endl;
}
