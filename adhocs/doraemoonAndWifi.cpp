...
void run_case(){
    ...
    if( questionMarks == 0 ){
        if( reached == finPos )cout << "1.000000000000" << endl;
        else cout << "0.000000000000" << endl;
        return;
    }
    double prob = 0;
    int togo =  questionMarks +finPos-reached;
    if( togo == 0 ){
        if( questionMarks%2 == 0 ){
            cout << "0.500000000000\n";
        }
        else cout << "0.000000000000" << endl;
        return;
    }
    cerr << questionMarks << " " <<  finPos << " " << reached << " " <<  togo << endl;
    cerr << choose(questionMarks, (togo/2)) << endl;
    prob = double(choose(questionMarks, abs(togo)))/double(pow(2, questionMarks));
